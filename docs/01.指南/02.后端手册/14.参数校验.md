...
在项目的 [`blossom-common`](https://github.com/EcoNetsTech/econets-vue/tree/master/blossom-framework/blossom-common)的 [`validation`](https://github.com/EcoNetsTech/econets-vue/tree/master/blossom-framework/blossom-common/src/main/java/cn/econets/blossom/framework/common/validation/)包下，就自定义了多个参数校验的注解，以 [`@Mobile`](https://github.com/EcoNetsTech/econets-vue/blob/master/blossom-framework/blossom-common/src/main/java/cn/econets/blossom/framework/common/validation/Mobile.java)注解来举例，它提供了手机格式的校验。
